...
export default async function OccurrencePage({ searchParams }: OccurrencePageProps) {
  ...
  const baseUrl = `/occurrence?${baseParams.toString()}`;
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold">Occurrence Trackers</h1>
      ...
      <TrackerFilters
        ...
        defaultType={TrackerType.OCCURRENCE}
      ...
      <div className="space-y-4">
        {trackers.length > 0 ? (
          ...
          <div className="bg-background border-border rounded-lg border p-6 text-center">
            <p className="text-foreground/70">No occurrence trackers found</p>
            <Link href="/trackers/new?type=OCCURRENCE" className="mt-2 inline-block">
              <Button variant="outline" size="sm">
                Create Your First Occurrence Tracker
              </Button>
            </Link>
          </div>
        )}
